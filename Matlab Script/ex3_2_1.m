...
%% set the path directory of the data to where the data located, for example:
load ('C:\Users\Ridho Rahmadi\Dropbox\Course Data Mining\02450Toolbox_Matlab\Data\wildfaces_grayscale.mat')
[N,M] = size(X);
